...
struct PackagingTests {
    static let root: URL = {
        ...
        return URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()  // BusinessIDTests
            .deletingLastPathComponent()  // Tests
            .deletingLastPathComponent()  // repository root
    }()

    static func librarySources() throws -> [(name: String, text: String)] {
        let library = root.appending(path: "Sources/BusinessID")
    ...
    func libraryHasNoDependency() throws {
        ...
        let declaration = try #require(manifest.range(of: #"name: "BusinessID","#))
    ...
    func generatedCodeIsPresent() throws {
        let generated = Self.root.appending(path: "Sources/BusinessID/Generated")
        for name in ["GeneratedRuleset.swift", "GeneratedPrograms.swift", "GeneratedLiterals.swift"] {
            ...
            #expect(text.hasPrefix("// Generated by businessid-gen. Do not edit by hand."))
        ...
        #expect(BusinessIDEngine.default.rulesVersion == locked)
    }
