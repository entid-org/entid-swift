...
struct CodableTests {
    ...
    func canonicalizationRoundTrip() throws {
        let result = EntIDEngine.default.canonicalize(
    ...
    func reportFieldNames() throws {
        let object = try encoded(
            EntIDEngine.default.validate(IdentifierInput(kind: "siren", value: "012345674"))
        )
