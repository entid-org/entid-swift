...
struct Bench {
    static func main() async {
        ...
        print("entid-bench: \(iterations) iterations per case, release build recommended")
        print("")
        ...
        if let bundle = FileManager.default.contents(atPath: "spec/entid-rules.binpb") {
