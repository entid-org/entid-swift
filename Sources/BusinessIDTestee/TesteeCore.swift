...
package enum TesteeCore {
    ...
    private static func step(_ result: BusinessID.StepResult) -> Libbusinessid_Testee_V1_ObservedStep {
    ...
    private static func wire(_ status: BusinessID.StepStatus) -> Libbusinessid_Conformance_V1_StepStatus {
        switch status {
        case .valid: .valid
    ...
    private static func wire(_ reason: BusinessID.ReasonCode) -> Libbusinessid_Ir_V1_ReasonCode {
        switch reason {
        case .ok: .ok
        case .empty: .empty
